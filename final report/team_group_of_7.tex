...
\begin{document}
	...
	\par In our program, we have three different objects: \textbf{Sphere}, \textbf{Cube} and \textbf{Plane}. The class diagram for this part of our program is shown in Figure \ref{fig:objcd}.
	...
	\begin{itemize}
		...
		\begin{itemize} 
			\item Position: which is a 3D point represents the position of the camera in the scene.
			\item lookAt: which is a 3D vector represents the direction of how to look at the scene.
		\end{itemize}
