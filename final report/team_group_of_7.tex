...
\begin{document}
	...
	There are many basic elements which are required to be implemented in order to build a ray tracer. These elements were reflected in our project as classes: 
	\begin{itemize}
