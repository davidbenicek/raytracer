...
%TODO : CHECK SPELLING: colour, front-end, back-end,ray tracer 
...
\begin{document}
	...
	%DB-NOTE: @Aadam, this would be a good place to talk about why our prototypes look the way they do
	% just be like - we made the design lik this cause it's easy both for us and for the user. Therefore even after the first couple iterations we would be delivering a complete product. Then we decied to not think about waht's easy but what's best for the user...we came up with the 2nd prototype that is much more refined....talk about how it's easier to use a GUI rather than fill out a form etc
	...
	% 	@David, justified our low fidelity prototype above^ 
	...
	% 	@David more of that justification you love so much above
	
	%Note: HM - I think we should have the final prototype. We can just take a screenshot of the webpage. DB: I agree @Aadam plz do that. There's two files called final-all.png and finaldesign-top.png in the project - pick one 
	...
	\section{Process}
	%DB-NOTE: Talk about how we used to go issue by issue, then went to going by what you actually did - this was to make sure that we covered everything...it's kind of bullshit but it fits with the communication paragraph I wrote in the evaluation @Aadam
	...
	%NOTE: HM - I spoke about having two meetings and how that went well in the evaluation. Can we write a line or two expanding that here as well? @Aadam - also watch out you have TODO there 
